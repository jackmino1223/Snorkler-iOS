...
//                self?.performSegue(withIdentifier: "toAddInterest", sender: self)
                ...
                let vc = storyBoard.instantiateViewController(withIdentifier: "AddInterestViewController") as! AddInterestViewController
                self?.present(vc, animated: true, completion: nil)
                vc.continueButton.setTitle("Continue", for: .normal)
